        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <Select v-model="formData.type" required>
              ...
              <SelectContent>
                <SelectItem 
                  v-for="(typeInfo, typeKey) in Object.entries(agentTypes)"
                  :key="typeKey"
                  :value="typeKey"
                ...
                >
                  <div class="flex items-center justify-between w-full">
                    ...
                    <div class="flex items-center space-x-1">
                      <Badge v-if="typeInfo.comingSoon" variant="outline" class="text-xs h-5">Coming Soon</Badge>
                      <Badge v-if="typeInfo.pro" variant="secondary" class="text-xs h-5">Pro</Badge>
                    </div>
                  </div>
                </SelectItem>
              </SelectContent>
