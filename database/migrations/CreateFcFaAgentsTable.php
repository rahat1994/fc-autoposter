...
class CreateFcFaAgentsTable extends Migration {
    ...
    public function shouldRun() {
        ...
        if (!$table_exists) {
            error_log("FC Autoposter: Agents table does not exist, migration needed");
            return true;
        }
        ...
        if ($version_outdated) {
            error_log("FC Autoposter: Agents table version outdated (current: {$current_version}, target: {$this->version})");
            return true;
        }
        
        error_log("FC Autoposter: Agents table migration not needed (version: {$current_version})");
        return false;
    }
